...
const FOOTER_COLS = [
  { title:"Platform", links:["Browse Tenders","GeM Portal","CPPP Integration","Bid Management","Analytics"] },
  { title:"Company",  links:["About Us","Careers","Press & Media","Partners","Contact"] },
  { title:"Support",  links:["Help Center","API Docs","Privacy Policy","Terms of Service","Refund Policy"] },
];
      ...
      <div className="container-xl py-5">
        <div className="row g-4">
          <div className="col-md-4">
            <div className="footer-brand mb-2" style={{cursor:"pointer"}} onClick={()=>navigate("/")}>
              Procure<span style={{color:"var(--gem-sky)"}}>Brain</span>
            </div>
            <p style={{fontSize:".87rem",lineHeight:1.7,maxWidth:280,marginBottom:20}}>
              India's most comprehensive multi-tenant tender intelligence platform. Track, bid, and win government contracts seamlessly.
            </p>
          ...
          <div className="col-md-2">
            ...
            <div className="footer-contact-info">
              ...
              <div>📧 support@procurebrain.in</div>
